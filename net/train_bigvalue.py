...
class ChessValueNet(nn.Module):
    def __init__(self):
        ...
        self.hl0 = nn.Linear(768, 256)   # Input to Hidden 1
        self.hl1 = nn.Linear(256, 256)    # Hidden 1 to Hidden 2
        self.hl2 = nn.Linear(256, 256)    # Hidden 2 to Hidden 3
        self.hl3 = nn.Linear(256, 1)     # Hidden 3 to Output
